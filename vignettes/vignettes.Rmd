...
author: "Koyel Majumdar, Thomas Brendan Murphy and Isobel Claire Gormley"
...
```{r output2,include=TRUE, echo=TRUE,fig.width = 5, fig.height = 4,dev = 'svg'}
...
```{r output3,include=TRUE, echo=TRUE,fig.width = 5, fig.height = 4,dev = 'svg',warning=FALSE}
...
```{r output4,include=TRUE, echo=TRUE,fig.width = 6, fig.height = 5, dev = 'svg'}
...
```{r dmcoutput2,include=TRUE, echo=TRUE,fig.width = 6.5, fig.height = 5,dev = 'svg'}
...
```{r dmcoutput3,include=TRUE, echo=TRUE,fig.width = 6.5, fig.height = 5,dev = 'svg'}
...
```{r dmcoutput4,include=TRUE, echo=TRUE,fig.width = 6, fig.height = 5, dev = 'svg'}
...
```{r dmcoutput5,include=TRUE, echo=TRUE,fig.width = 6, fig.height = 5,dev = 'svg'}
...
```{r wrapperoutput2,include=TRUE, echo=TRUE,fig.width = 6.5, fig.height = 5,dev = 'svg'}
...
```{r wrapperoutput3,include=TRUE, echo=TRUE,fig.width = 4, fig.height = 4,dev = 'svg'}
plot(wrapper_out, what = "information criterion", plot_type = "ggplot")
```


# References
Silva, R., Moran, B., Russell, N.M., Fahey, C., Vlajnic, T., Manecksha, R.P., Finn, S.P., Brennan, D.J., Gallagher, W.M., Perry, A.S.: Evaluating liquid biopsies for methylomic profiling of prostate cancer. Epigenetics 15(6-7), 715-727 (2020). https://doi.org/10.1080/15592294.2020.1712876.

Majumdar, K., Silva, R., Perry, A.S., Watson, R.W., Murphy, T.B., Gormley, I.C.: betaclust: a family of mixture models for beta valued DNA methylation data. arXiv [stat.ME] (2022). https://doi.org/10.48550/ARXIV.2211.01938.

Mueller F, Scherer M, Assenov Y, Lutsik P, Walter J, Lengauer T, Bock C (2019): RnBeads 2.0: comprehensive analysis of DNA methylation data. Genome Biology, 20(55). https://doi.org/10.1186/s13059-019-1664-9.
...
research. 2011;23(4):306-311. https://doi.org/10.1007/s11670-011-0306-x.

Fraley, C., Raftery, A.E.: How many clusters? which clustering method? answers via model-based cluster analysis. The Computer Journal 41, 578-588 (1998). https://doi.org/10.1093/comjnl/41.8.578.

Dempster, A., Laird, N., Rubin, D.: Maximum likelihood from incomplete data via the EM algorithm. Journal of the Royal Statistical Society. Series B (Methodological), 39(1), 1–38 (1977). https://www.jstor.org/stable/2984875.

Diamond, H.G., Straub, A.: Bounds for the logarithm of the Euler gamma function and its derivatives. Journal of Mathematical Analysis and Applications 433(2), 1072-1083 (2016). https://doi.org/10.1016/j.jmaa.2015.08.034.
