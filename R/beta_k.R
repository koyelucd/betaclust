...
#'              The K.. model analyses a single DNA sample and identifies the thresholds for the different methylation profiles.
#'
#' @export
#'
...
#' Under the K.. model the shape parameters of each cluster are constrained to be equal for each patient.
#'
...
beta_k<-function(data,M=3,seed,register=NULL){
